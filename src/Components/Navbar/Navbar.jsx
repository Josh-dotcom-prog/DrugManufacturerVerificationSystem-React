...
const DrugVerificationSystem = () => {
    ...
    useEffect(() => {
        ...
        const handleResize = () => {
            // Can also use width-based detection in addition to user agent
            const isMobileWidth = window.innerWidth < 768;
            setIsMobile(isMobileWidth || /android|webos|iphone|ipad|ipod|blackberry|iemobile|opera mini/i.test(
        ...
        <div className="flex flex-col min-h-screen">
            ...
            <main className="container mx-auto px-4 py-8 flex-grow">
                ...
                <section className="text-center py-8 mb-12">
                    ...
                    {/* Manufacturer link that will be hidden on mobile */}
                    {!isMobile && (
                        <div className="mt-6">
                            <Link
                                to="/login"
